...
const MyPaymentHistoryScreen = () => {
  const myPaymentHistory = [
    ...
    { paymentType: 'Weekly', amountPaid: 50, paymentDate: '2023-04-01', expirationDate: '2023-04-08' },
    { paymentType: 'Weekly', amountPaid: 50, paymentDate: '2023-04-15', expirationDate: '2023-04-22' },
    { paymentType: 'Daily', amountPaid: 20, paymentDate: '2023-05-01', expirationDate: '2023-05-01' },
    { paymentType: 'Daily', amountPaid: 20, paymentDate: '2023-05-02', expirationDate: '2023-05-02' },
